...
dataset = pd.read_csv("C:/Users/user/Downloads/wc-at.csv")

X = dataset.iloc[:,0]

y = dataset.iloc[:,1]

X = dataset['Waist'].values.reshape(-1,1)
y = dataset['AT'].values.reshape(-1,1)
...
pickle.dump(regressor, open('model_wcat.pkl','wb'))
